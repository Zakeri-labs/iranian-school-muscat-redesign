        ...
        <div className="grid lg:grid-cols-3 gap-5">
          <div className="lg:col-span-2">
            <Card className="p-6">
              <SectionTitle
                title="فرم تماس"
                description="پیام خود را برای ما ارسال کنید؛ در اسرع وقت پاسخ می‌دهیم."
              />
          ...
          <aside className="space-y-4">
            <Card className="p-5 space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="font-semibold text-primary">{site.email}</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="font-semibold text-primary">{site.address}</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="font-semibold text-primary">شنبه تا چهارشنبه · ۸ تا ۱۵</div>
                </div>
              </div>
            </Card>
            <Card className="p-2 overflow-hidden">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="aspect-video rounded-md bg-muted flex items-center justify-center text-muted-foreground text-sm transition-colors hover:text-brand"
              >
